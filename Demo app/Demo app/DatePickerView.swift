...
extension DatePickerView{
    ...
    func openDatePicker(){
        ...
        let btnCancel = UIBarButtonItem(title: Constants.btnCancel, style: .plain , target: self, action: #selector(self.onClickCancelBtn))
        let btnDone = UIBarButtonItem(title: Constants.btnDone, style: .plain , target: self, action: #selector(self.onClickDoneBtn))
